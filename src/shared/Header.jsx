    ...
    <>
      <div className="flex flex-row items-center gap-4 p-4 ">
        ...
        <label className="relative block pl-32 ">
          ...
          <input
            className=" placeholder:text-white block bg-background-light w-[555px] border border-accent rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:ring-accent focus:ring-1 sm:text-sm"
